...
# Benchmark: 317x85 characters, aka 317x170 pixels.
# * default params:
# ** perl-only: 3.237s
# ** SIMD engine accellerated: 8.739s
# ** Verdict: SIMD 2.7x slower
# * brighter jewel: -0.7491035737	0.03664336998	4.48E-14	65535
# ** perl-only: 3m12.664s
# ** SIMD engine accellerated: 13.699s
# ** Verdict: SIMD 14x FASTER
#############
# CLI arguments:
